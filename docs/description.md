...
1. Quản lý thông tin Học sinh – Phụ huynh
2. Tạo và lên lịch Lớp học cho học sinh
3. Quản lý Subscription (gói học) cơ bản: khởi tạo, theo dõi buổi đã dùng/ còn lại
...
1. Source code của backend + frontend (push lên GitHub/GitLab riêng tư, kèm link)
2. README.md trong root chứa:
...
5. (Tùy chọn) Postman collection hoặc script curl demo các API

Thời hạn hoàn thành bài test: 60 phút kể từ khi nhận được đề bài 

Bạn hãy reply lại email này và gửi bài test về email: [careers@teenup.vn](mailto:careers@teenup.vn), [canhvu.teenup@gmail.com](mailto:canhvu.teenup@gmail.com)\*\*
